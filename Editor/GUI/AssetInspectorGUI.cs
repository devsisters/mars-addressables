            ...
            */
            ...
            else
            {
                ...
                foreach (var info in otherTargetInfos)
                {
                    ...
                    if (hook != null) hook.BeforeSetEntryOnInspectorGUI(info.Path, out assetGroup, out customAddress);
                    if (assetGroup == null) assetGroup = aaSettings.DefaultGroup;

                    var e = aaSettings.CreateOrMoveEntry(info.Guid, assetGroup, false, false);
